...
class HRRequestDocListItem extends StatelessWidget
                ...
                child: Column(
                  children: [
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            Expanded(
                              child: Text(
                                  '№ ${hrRequestDoc.orderDescriptor.number} от ${DateFormat('dd.MM.yyyy').format(hrRequestDoc.orderDescriptor.issuedDate).toString()}'),
                            ),
                    ...
                    ListTile(
                      title: Row(
                        children: [
                          Expanded(child: Text('${hrRequestDoc.compileTitle}')),
                        ],
                      ),
                      subtitle: Column(
                        ...
                        children: <Widget>[
                          Row(
                            children: [
                              Text('Адресат: '),
                              UserItem(userId: hrRequestDoc.addressee),
                            ],
                          ),
                          Row(
                            children: [
                              Text('Ответственный: '),
                              UserItem(userId: hrRequestDoc.responderId),
                            ],
                          ),
                        ],
                      ),
