...
class RequestForDismissalItemPage extends StatelessWidget
  ...
  Widget build(BuildContext context) {
    return RequestForDismissalItemDisplay(
      item: item,
      isLoading: isLoading,
      onQuery: onQuery,
      onCreate: onCreate,
...
// ignore: must_be_immutable
class RequestForDismissalItemDisplay extends StatefulWidget {
  GetDocument$DFSQuery$DocumentQueryAPI$Document item;
  bool isLoading;
  Function(String) onQuery;
  Function(String) onCreate;
  ...
  RequestForDismissalItemDisplay({
    Key key,
    this.isLoading,
    this.item,
    this.onQuery,
  ...
  @override
  _RequestForDismissalItemDisplayState createState() =>
      _RequestForDismissalItemDisplayState();
}

class _RequestForDismissalItemDisplayState
    extends State<RequestForDismissalItemDisplay>
