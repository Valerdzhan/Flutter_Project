...
class ContractItemPage extends StatelessWidget implements IDocumentItem {
...
// ignore: must_be_immutable
class ContractItemDisplay extends StatefulWidget {
  GetDocument$DFSQuery$DocumentQueryAPI$Document item;
  bool isLoading;
  Function(String) onQuery;
  Function(String) onCreate;
  ...
  @override
  _ContractItemDisplayState createState() => _ContractItemDisplayState();
}

class _ContractItemDisplayState extends State<ContractItemDisplay>
