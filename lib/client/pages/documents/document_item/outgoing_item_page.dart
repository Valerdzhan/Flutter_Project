...
class OutgoingDocItemPage extends StatelessWidget implements IDocumentItem {
...
// ignore: must_be_immutable
class OutgoingItemDisplay extends StatefulWidget {
  GetDocument$DFSQuery$DocumentQueryAPI$Document item;
  bool isLoading;
  Function(String) onQuery;
  Function(String) onCreate;
  ...
  @override
  _OutgoingItemDisplayState createState() => _OutgoingItemDisplayState();
}

class _OutgoingItemDisplayState extends State<OutgoingItemDisplay>
