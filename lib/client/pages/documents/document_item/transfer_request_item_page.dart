...
class TransferRequestItemPage extends StatelessWidget implements IDocumentItem {
  ...
  Widget build(BuildContext context) {
    return TransferRequestItemDisplay(
      item: item,
      isLoading: isLoading,
      onQuery: onQuery,
      onCreate: onCreate,
...
// ignore: must_be_immutable
class TransferRequestItemDisplay extends StatefulWidget {
  GetDocument$DFSQuery$DocumentQueryAPI$Document item;
  bool isLoading;
  Function(String) onQuery;
  Function(String) onCreate;
  ...
  @override
  _TransferRequestItemDisplayState createState() =>
      _TransferRequestItemDisplayState();
}

class _TransferRequestItemDisplayState extends State<TransferRequestItemDisplay>
