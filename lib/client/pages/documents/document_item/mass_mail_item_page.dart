...
class MassMailItemPage extends StatelessWidget implements IDocumentItem {
...
// ignore: must_be_immutable
class MassMailItemDisplay extends StatefulWidget {
  GetDocument$DFSQuery$DocumentQueryAPI$Document item;
  bool isLoading;
  Function(String) onQuery;
  Function(String) onCreate;
  ...
  @override
  _MassMailItemDisplayState createState() => _MassMailItemDisplayState();
}

class _MassMailItemDisplayState extends State<MassMailItemDisplay>
