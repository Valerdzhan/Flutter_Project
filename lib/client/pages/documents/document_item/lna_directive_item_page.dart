...
class LNADirectiveItemPage extends StatelessWidget implements IDocumentItem {
  ...
  Widget build(BuildContext context) {
    return LNADirectiveItemDisplay(
      item: item,
      isLoading: isLoading,
      onQuery: onQuery,
      onCreate: onCreate,
...
// ignore: must_be_immutable
class LNADirectiveItemDisplay extends StatefulWidget {
  GetDocument$DFSQuery$DocumentQueryAPI$Document item;
  bool isLoading;
  Function(String) onQuery;
  Function(String) onCreate;
  ...
  @override
  _LNADirectiveItemDisplayState createState() =>
      _LNADirectiveItemDisplayState();
}

class _LNADirectiveItemDisplayState extends State<LNADirectiveItemDisplay>
