...
class TaskProcessingItemPage extends StatefulWidget {
  UserTasks$DFSQuery$UserTasks$Items$ProcessingTaskListItemType task;
  ...
  @override
  _TaskProcessingItemPageState createState() => _TaskProcessingItemPageState();
}

class _TaskProcessingItemPageState extends State<TaskProcessingItemPage>
    ...
    return Scaffold(
        appBar: AppBar(
          title: RichText(
            ...
            text: TextSpan(
              text: widget.task.internalTaskType.toString(),
