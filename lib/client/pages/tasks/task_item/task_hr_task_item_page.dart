...
class TaskHRItemPage extends StatefulWidget {
  UserTasks$DFSQuery$UserTasks$Items$ForHRDecisionTaskListItemType task;
  ...
  @override
  _TaskHRItemPageState createState() => _TaskHRItemPageState();
}

class _TaskHRItemPageState extends State<TaskHRItemPage>
    ...
    return Scaffold(
        appBar: AppBar(
          title: RichText(
            ...
            text: TextSpan(
              text: widget.task.decisionTaskType.toString(),
