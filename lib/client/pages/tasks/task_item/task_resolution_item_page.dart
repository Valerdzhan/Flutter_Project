...
class TaskResolutionItemPage extends StatefulWidget {
  UserTasks$DFSQuery$UserTasks$Items$ResolutionTaskListItemType task;
  ...
  @override
  _TaskResolutionItemPageState createState() => _TaskResolutionItemPageState();
}

class _TaskResolutionItemPageState extends State<TaskResolutionItemPage>
    ...
    return Scaffold(
        appBar: AppBar(
          title: RichText(
            ...
            text: TextSpan(
              text: widget.task.resolutionTaskType.toString(),
