import 'package:myapp/models/User/userActionItem.dart';
import 'package:myapp/models/User/vacation.dart';
...
class UserItem
    {
        ...
        final Dictionary<String, String> identity;// = new Dictionary<String, String>();
        ...
        factory UserItem.fromJson(Map<String, dynamic> json) {
          return UserItem(
            ...
            actions: json['actions'].map((i) => UserActionItem.fromJson(i)).toList()
          );
        }
    }